...
from geometry_yaw_v2.yaw_static_direction import _world_yaw_to_local
from geometry_yaw_v2.yaw_vehicle_dynamic import (
...
def apply_yaw_integrated(
    ...
    priority = []                                        # 【改动】
    if getattr(vehicle_config, "apply_static_direction_vote", True):
        priority.append("static_direction_vote")
    ...
    diagnostics["policy"]["apply_static_direction_vote"] = bool(      # 【改动】
        getattr(vehicle_config, "apply_static_direction_vote", True))
    diagnostics["policy"]["apply_straight_motion_yaw"] = bool(        # 【改动】
        getattr(vehicle_config, "apply_straight_motion_yaw", False))
